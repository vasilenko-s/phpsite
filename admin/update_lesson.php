...
$result=mysqli_query($db, "UPDATE lessons SET title='$title', meta_d='$meta_d', meta_k='$meta_k', date='$date', description='$description', text='$text', author='$author' WHERE id='$id'");						
												
											 
//	Выводим сообщение о результате операции записи урока в базу
		if ($result==true)
		{
			echo "<p> Урок успешно обновлен</p>";
		}
		else {
			echo "<p> Урок не обновлен</p>";
		 }
	}
			else {
				echo "Вы ввели не все данные поэтому урок не может быть обновлен";
			}
