...
$result=mysqli_query($db, "INSERT INTO articles (title, meta_d, meta_k, description, text, author, date)   VALUES ('$title', '$meta_d', '$meta_k', '$description', '$text', '$author', '$date')");
...
//	Выводим сообщение о результате операции записи урока в базу
						if ($result==true)
						{
							echo "<p> Статья успешно добавлена в базу данных!</p>";
						}
						else echo "<p> Статья не добавлен в базу, потому что вы ввели не все данные.</p>";
						?>					 			 
				  </td>
				</tr>
				</tbody>
